...
Copy all files in the folder \source_code in one designated folder.

## Usage

Open `main.py` and run the code. You will be greeted by the main menu in your terminal. Choose from the options listed to add, search, print, change, and delete completed tickets. Each option will guide the user for specific actions. To exit the program, use the exit option.
